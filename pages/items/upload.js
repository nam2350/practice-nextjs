...
const Upload = () => {
  return (
    <div className="px-4 space-y-5 py-10">
      <div>
        <label className="w-full cursor-pointer text-gray-600 hover:border-purple-700 hover:text-purple-700 flex items-center justify-center border-2 border-dashed border-gray-300 h-48 rounded-md">
          <svg
            className="h-12 w-12"
            stroke="currentColor"
            fill="none"
