      ...
      <div className="py-10 px-4">
        ...
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center">
            <div className="w-14 h-14 text-white bg-purple-700 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
            ...
            <span className="text-sm mt-2 font-medium text-gray-700">코인</span>
          </div>
          <div>
            <div className="w-14 h-14 text-white bg-purple-700 rounded-full flex items-center justify-center">
              <svg
        ...
        <div className="mt-12">
          <div className="flex space-x-4 items-center">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-900">3577</h4>
